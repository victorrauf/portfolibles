        ...
        <main className="min-h-screen flex justify-center mt-[108px] lg:mt-[120px] lg:pt-0 px-3 md:px-0">
            <div className="h-full w-full md:w-[320px] flex flex-col gap-8 border border-gray-400 rounded-md p-3 md:p-5">
                ...
                className="flex flex-col gap-3">
                    <button
                    type="submit"
                    className="w-full h-[56px] flex justify-center items-center gap-6 border border-gray-800 rounded-md">
                        <FcGoogle className="text-3xl"/> 
                        <span className="text-gray-700">Google</span>
                    </button>
                    <button type="submit" className="w-full h-[56px] flex justify-center items-center gap-6 border border-gray-800 rounded-md">
